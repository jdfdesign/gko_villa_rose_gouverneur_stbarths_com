# This migration comes from gko_core (originally 20130127140000)
# This is a compressed migration for creating all Gko 1.0.0 tables at once.
#
# === Notice
#
# In order to upgrade from an old version of Gko, you have to run all migrations from
# each version you missed up to the version you want to upgrade to, before running this migration.
#
class GkoOneZero < ActiveRecord::Migration
  def up
    # Do not run if Gko tables are already present
